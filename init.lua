...
require("lazy").setup({
	...
	{ -- Useful plugin to show you pending keybinds.
		...
		config = function() -- This is the function that runs, AFTER loading
			...
			-- MJ: commented out 9-14-24.  :checkhealth which-key shows suggested new format, but when
			-- replacing these it messes things up. If I don't replace then annoying warning message
			-- on opening nvim
			--
	...
	{ -- LSP Configuration & Plugins
		...
		config = function()
			...
			-- MJ: attempt to get the syntax highlighting working for the alabaster color scheme
		...
		dependencies = {
			...
			-- { "zbirenbaum/copilot.lua" },
			{
				...
				opts = {
					...
					panel = { enabled = true }, -- Keep Copilot panel enabled
				},
			},
